...
ATTACK_USERNAME = "justus.johansson"              PASS_BASE = "JohJus"
...
RATE_LIMIT_PAUSE = 5   # пауза N секунд

# Резюма / контроль точки (checkpoint)            # Если хочешь начать с конкретной даты (DDMM), укажи её:
